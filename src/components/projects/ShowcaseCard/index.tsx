...
import {Tags, TagList, TagType, User, Tag} from '../../../data/projects';
        ...
        <div className="card__body">
          <div className="avatar">
            <div className="avatar__intro margin-left--none">
              ...
              <small className="avatar__subtitle"><strong>{user.course}, {user.semester}</strong></small>
              <small className="avatar__subtitle">{user.description}</small>
              <small className="avatar__subtitle"><em>{user.participants}</em></small>
            </div>
          </div>
        </div>
